...
export abstract class zzMockTestService extends BehaviorSubject<GridDataResult> {
...
@Injectable()
export class ProductsService extends zzMockTestService {
...
@Injectable()
export class CategoriesService extends zzMockTestService {
